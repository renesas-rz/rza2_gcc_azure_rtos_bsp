...
#define STDIO_MMU_RZ_LLD_VERSION_MINOR      (4)
/** Minor Version Number of API */
...
/* Normal, secure, and non-cacheable */
#define MMU_ATTR_NORMAL_S                   (MMU_ATTR_NORMAL_BASE                                                 |MMU_ATTR_AP1|MMU_ATTR_AP0)
/* Normal, secure, and L1 cacheable */
#define MMU_ATTR_NORMAL_S_L1CACHE           (MMU_ATTR_NORMAL_BASE                          |MMU_ATTR_CACHE(1,0)   |MMU_ATTR_AP1|MMU_ATTR_AP0)
/* Normal, secure, and L2 cacheable */
#define MMU_ATTR_NORMAL_S_L2CACHE           (MMU_ATTR_NORMAL_BASE                          |MMU_ATTR_CACHE(0,1)   |MMU_ATTR_AP1|MMU_ATTR_AP0)
/* Normal, secure, and L1/L2 cacheable */
#define MMU_ATTR_NORMAL_S_L1L2CACHE         (MMU_ATTR_NORMAL_CACHED_BASE                                          |MMU_ATTR_AP1|MMU_ATTR_AP0)
 ...
 ******************************************************************************/
#if defined( __ARMCC_VERSION ) /* CC_ARM toolchain */
extern uint32_t Image$$MMU_PAGE_TABLE$$Base;
#elif defined( __ICCARM__ ) /* IAR toolchain */
#elif defined( __GNUC__ ) /* GCC toolchain */
extern uint32_t __mmu_page_table_base;
#else
#error "r_mmu_lld_rza2m.h is not implemented for your toolchain"
#endif
