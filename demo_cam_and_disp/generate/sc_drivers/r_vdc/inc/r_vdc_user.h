 ...
 *********************************************************************************************************************/
/**************************************************************************//**
 * File Name :   r_vdc_user.h
 * @file         r_vdc_user.h
 * @version      1.12
 * @brief        RZ/A2M VDC driver user-defined header
 ******************************************************************************/
/******************************************************************************
...
#define VDC_RZA2_VERSION_MAJOR (1)
#define VDC_RZA2_VERSION_MINOR (11)

#define VDC_INTERRUPT_PRIORITY  (5u)
...
#define     VDC_LVDS_PLL_WAIT_CYCLE        (38u)
/*! 200usec wait counter for LVDS PLL */
#define     VDC_LVDS_PLL_WAIT_200USEC      (13400u)
