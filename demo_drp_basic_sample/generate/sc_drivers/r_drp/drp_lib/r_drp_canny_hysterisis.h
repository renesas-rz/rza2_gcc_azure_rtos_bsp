...
*******************************************************************************/
/*******************************************************************************
* File Name    : r_drp_canny_hysterisis.h
* Description  : This source code is the header file of Canny hysterisis processing.
* Version      : 1.00
*******************************************************************************/
#ifndef R_DRP_CANNY_HYSTERISIS_H
#define R_DRP_CANNY_HYSTERISIS_H
...
typedef struct
{
    ...
    uint8_t iterations;     /* Number of repetitions of edge scan. */
