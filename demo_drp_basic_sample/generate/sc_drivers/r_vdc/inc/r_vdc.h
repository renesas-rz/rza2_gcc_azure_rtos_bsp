...
typedef struct
{
    ...
    const vdc_sync_delay_t
    * dly;        /*!< Sync signal delay adjustment parameter */ 
    const vdc_ext_in_sig_t
    * ext_sig;    /*!< External input signal parameter */ 
} vdc_input_t;
...
typedef struct
{
    ...
    * vsync_cpmpe;    /*!< Vsync signal compensation parameter */ 
} vdc_sync_ctrl_t;
...
typedef struct
{
    ...
    void
        (* callback)(vdc_int_type_t);  /*!< Interrupt callback function pointer */ 
...
typedef struct
{
    ...
    const vdc_width_read_fb_t
        * width_read_fb;  /*!< Size of the frame buffer to be read */ 
...
typedef struct
{
    ...
    const vdc_width_read_fb_t
        * width_read_fb;  /*!< Size of the frame buffer to be read */ 
    const vdc_period_rect_t
        * gr_grc;         /*!< Graphics display area */ 
    const vdc_gr_disp_sel_t
        * gr_disp_sel;    /*!< Graphics display mode */ 
} vdc_read_chg_t;
...
typedef struct
{
    const vdc_alpha_argb1555_t /*!< Alpha signal of the ARGB1555/ARGB5551 format */
        * alpha_1bit;  
    const vdc_alpha_pixel_t  /*!< Premultiplication processing at alpha blending in one-pixel */
        * alpha_pixel; 
...
typedef struct
{
    const vdc_pd_disp_rect_t  /*!< Rectangular area subjected to alpha blending */
        * gr_arc;     
    const vdc_alpha_rect_t  /*!< Parameter for alpha blending in a rectangular area */
        * alpha_rect;  
    const vdc_scl_und_sel_t   /*!< Selection of lower-layer plane in scaler */
        * scl_und_sel; 
...
typedef struct
{
    ...
    const vdc_calibr_bright_t     /*!< Brightness (DC) adjustment parameter */
        * bright;          
    const vdc_calibr_contrast_t  /*!< Contrast (gain) adjustment parameter */
        * contrast;        
    const vdc_calibr_dither_t   /*!< Panel dithering parameter */
        * panel_dither;   
...
typedef struct
{
    const uint16_t    /*!< Gain adjustment of area 0 to 31 of G signal */
        * gam_g_gain;      
    const uint8_t     /*!< Start threshold of area 1 to 31 of G signal */
        * gam_g_th;        
    const uint16_t    /*!< Gain adjustment of area 0 to 31 of B signal */
        * gam_b_gain;      
    const uint8_t     /*!< Start threshold of area 1 to 31 of B signal */
        * gam_b_th;        
    const uint16_t    /*!< Gain adjustment of area 0 to 31 of R signal */
        * gam_r_gain;      
    const uint8_t     /*!< Start threshold of area 1 to 31 of R signal */
        * gam_r_th;        
 ...
 * @retval      Error code
 *****************************************************************************/
vdc_error_t R_VDC_Terminate 
    (const vdc_channel_t ch, void (* const quit_func)(uint32_t), const uint32_t user_num);
 ...
 * @retval      Error code
 *****************************************************************************/
vdc_error_t R_VDC_CallbackISR 
    (const vdc_channel_t ch, const vdc_int_t * const param);

/**************************************************************************//**
 * @fn          R_VDC_WriteDataControl
 ...
 * @retval      Error code
 *****************************************************************************/
vdc_error_t R_VDC_StopProcess 
    (const vdc_channel_t ch, const vdc_layer_id_t layer_id);

/**************************************************************************//**
 * @fn          R_VDC_ReleaseDataControl
 ...
 * @retval      Error code
 *****************************************************************************/
vdc_error_t R_VDC_ReleaseDataControl 
    (const vdc_channel_t ch, const vdc_layer_id_t layer_id);

/**************************************************************************//**
 * @fn          R_VDC_VideoNoiseReduction
 ...
 * @retval      Error code
 *****************************************************************************/
vdc_error_t R_VDC_CLUT 
    (const vdc_channel_t ch, const vdc_layer_id_t layer_id, const vdc_clut_t * const param);

/**************************************************************************//**
 * @fn          R_VDC_DisplayCalibration
 ...
 *****************************************************************************/
void (*R_VDC_GetISR 
    (const vdc_channel_t ch, const vdc_int_type_t type))(const uint32_t int_sense);
