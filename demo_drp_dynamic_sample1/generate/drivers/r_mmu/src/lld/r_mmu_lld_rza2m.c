...
#else
#error "r_mmu_lld_rza2m.c is not implemented for your toolchain"
#endif
/******************************************************************************
...
void R_MMU_Init(void)
{
     ...
     */
#if defined( __ARMCC_VERSION ) /* CC_ARM toolchain */
    uint32_t ttbr0 = (uint32_t) & (Image$$MMU_PAGE_TABLE$$Base) | 0x48;
#elif defined( __ICCARM__ ) /* IAR toolchain */
    uint32_t ttbr0 = (uint32_t)__section_begin("TTB") | 0x48;
#elif defined( __GNUC__ ) /* GCC toolchain */
