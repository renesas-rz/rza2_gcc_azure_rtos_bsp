...
*******************************************************************************/
/*******************************************************************************
* File Name    : r_drp_gamma_correction.h
* Description  : This source code is the header file of Gamma correction processing.
* Version      : 1.01
*******************************************************************************/
#ifndef R_DRP_GAMMA_CORRECTION_H
#define R_DRP_GAMMA_CORRECTION_H
...
typedef struct
{
    ...
    uint32_t table;		/* Address of Lookup table */
