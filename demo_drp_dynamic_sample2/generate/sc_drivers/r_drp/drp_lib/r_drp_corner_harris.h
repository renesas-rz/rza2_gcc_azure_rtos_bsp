...
*******************************************************************************/
/*******************************************************************************
* File Name    : r_drp_corner_harris.h
* Description  : This source code is the header file of Corner Harris detection processing.
* Version      : 1.00
*******************************************************************************/
#ifndef R_DRP_CORNER_HARRIS_H
#define R_DRP_CORNER_HARRIS_H
...
typedef struct
{
    ...
    uint8_t shift;      /* Right shift number of processing result */
