...
*******************************************************************************/
/*******************************************************************************
* File Name    : r_drp_canny_calculate.h
* Description  : This source code is the header file of Canny calculate processing.
* Version      : 1.00
*******************************************************************************/
#ifndef R_DRP_CANNY_CALCULATE_H
#define R_DRP_CANNY_CALCULATE_H
...
typedef struct
{
    ...
    uint8_t threshold_high; /* Threshlld of strong edge */
    uint8_t threshold_low;  /* Threshold of weak edge */
