...
/*******************************************************************************
* File Name    : r_drp_simple_isp_bg_subtraction.h
* Description  : This source code performs SimpleISP with backgournd subtraction.
* Version      : 1.00
*******************************************************************************/
#ifndef R_DRP_SIMPLE_ISP_BG_SUBTRACTION_H
#define R_DRP_SIMPLE_ISP_BG_SUBTRACTION_H
...
typedef struct
{
    ...
    uint8_t  mean_img_init;
    uint8_t  alpha;
    uint8_t  threshold_latest;
    uint8_t  threshold_diff;

}
r_drp_simple_isp_bg_subtraction_t;

#endif /* R_DRP_SIMPLE_ISP_BG_SUBTRACTION_H */
