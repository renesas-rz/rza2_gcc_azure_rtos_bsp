...
*******************************************************************************/
/*******************************************************************************
* File Name    : r_drp_unsharp_masking.h
* Description  : This source code is the header file of Unsharp mask filter processing.
* Version      : 1.00
*******************************************************************************/
#ifndef R_DRP_UNSHARP_MASKING_H
#define R_DRP_UNSHARP_MASKING_H
...
typedef struct
{
    ...
    uint8_t strength;   /* Filter strength */
