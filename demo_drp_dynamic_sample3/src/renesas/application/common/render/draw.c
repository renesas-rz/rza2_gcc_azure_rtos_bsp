...
void DrawInit( vdc_layer_id_t layer_id, draw_buffer_info * info ) 
{
    ...
    buffer_info[draw_layer].p_buff_addr1        = info->p_buff_addr1;
    buffer_info[draw_layer].p_buff_addr2        = info->p_buff_addr2;
...
void * DrawGetBackBuffer ( vdc_layer_id_t layer_id ) 
{
    ...
    return ((buffer_info[draw_layer].buff_select == 0u) ? buffer_info[draw_layer].p_buff_addr1
            : buffer_info[draw_layer].p_buff_addr2 );
...
void DrawPoint( vdc_layer_id_t layer_id, int32_t x, int32_t y , uint8_t color )
{
    ...
    /* buffer get */
    vram = ((buffer_info[draw_layer].buff_select == 0u) ? buffer_info[draw_layer].p_buff_addr1
            : buffer_info[draw_layer].p_buff_addr2 );
