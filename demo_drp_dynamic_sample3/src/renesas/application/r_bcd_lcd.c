...
#define     LAYER0_DISP_AREA_VW         (R_BCD_LCD_HEIGHT + 64)
...
#define     LAYER2_DISP_AREA_HW         (640)
#define     LAYER2_DISP_AREA_VW         (416)

#define     GRAPHICS2_BUFFER_STRIDE     (((LAYER2_DISP_AREA_HW / 2) +\
                                            (R_BCD_LCD_STRIDE - 1)) & ~(R_BCD_LCD_STRIDE - 1))
...
******************************************************************************/
static uint32_t video_buffer[VIDEO_BUFFER_NUM][(VIDEO_BUFFER_STRIDE *
        VIDEO_BUFFER_HEIGHT)] __attribute__ ((section("Video_RAM")));
static uint32_t video_buffer2[VIDEO_BUFFER_NUM][(VIDEO_BUFFER_STRIDE * 64)] __attribute__ ((section("Video_RAM")));
static uint8_t graphics2_buffer[GRAPHICS2_BUFFER_NUM][(GRAPHICS2_BUFFER_STRIDE *
        GRAPHICS2_BUFFER_HEIGHT)] __attribute__ ((section("Uncache_IRAM")));
...
static vdc_error_t r_display_init(const vdc_channel_t vdc_ch);
static vdc_error_t r_image_quality_adjustment(vdc_channel_t vdc_ch);
static vdc_error_t r_video_quality_adjustment(vdc_channel_t vdc_ch);
...
static vdc_error_t r_image_quality_adjustment(vdc_channel_t vdc_ch)
{
    ...
    if (VDC_OK == error)
    {
        ...
        static const uint16_t gam_b_gain[VDC_GAM_GAIN_ADJ_NUM] =
        {
            ...
            IMGC_GAMMA_B_GAIN_16, IMGC_GAMMA_B_GAIN_17, IMGC_GAMMA_B_GAIN_18, IMGC_GAMMA_B_GAIN_19,
            IMGC_GAMMA_B_GAIN_20, IMGC_GAMMA_B_GAIN_21, IMGC_GAMMA_B_GAIN_22, IMGC_GAMMA_B_GAIN_23,
            IMGC_GAMMA_B_GAIN_24, IMGC_GAMMA_B_GAIN_25, IMGC_GAMMA_B_GAIN_26, IMGC_GAMMA_B_GAIN_27,
            IMGC_GAMMA_B_GAIN_28, IMGC_GAMMA_B_GAIN_29, IMGC_GAMMA_B_GAIN_30, IMGC_GAMMA_B_GAIN_31
        };
        ...
        static const uint16_t gam_r_gain[VDC_GAM_GAIN_ADJ_NUM] =
        {
            ...
            IMGC_GAMMA_R_GAIN_16, IMGC_GAMMA_R_GAIN_17, IMGC_GAMMA_R_GAIN_18, IMGC_GAMMA_R_GAIN_19,
            IMGC_GAMMA_R_GAIN_20, IMGC_GAMMA_R_GAIN_21, IMGC_GAMMA_R_GAIN_22, IMGC_GAMMA_R_GAIN_23,
            IMGC_GAMMA_R_GAIN_24, IMGC_GAMMA_R_GAIN_25, IMGC_GAMMA_R_GAIN_26, IMGC_GAMMA_R_GAIN_27,
            IMGC_GAMMA_R_GAIN_28, IMGC_GAMMA_R_GAIN_29, IMGC_GAMMA_R_GAIN_30, IMGC_GAMMA_R_GAIN_31
        };
...
* Return Value : -
******************************************************************************/
void R_BCD_LcdWriteString 
        (uint8_t *pcode, uint32_t x, uint32_t y, uint8_t color)
{
    int i; 
    int len; 
