...
/*******************************************************************************
 * File Name   : r_drp_bayer2rgb_color_correction.h
 * Description : This source code is the header file of 
 *             : r_drp_bayer2rgb_color_correction.c
 * Version     : 1.01
 ******************************************************************************/
#ifndef R_DRP_BAYER2RGB_COLOR_CORRECTION
#define R_DRP_BAYER2RGB_COLOR_CORRECTION
...
typedef struct
{
	...
	uint16_t gain_r;  /* gain of red compornet */
	uint16_t gain_g;  /* gain of green compornet */
	uint16_t gain_b;  /* gain of blue compornet */
