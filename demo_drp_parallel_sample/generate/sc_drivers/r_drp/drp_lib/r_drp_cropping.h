...
*******************************************************************************/
/*******************************************************************************
* File Name    : r_drp_cropping.h
* Description  : This source code is the header file of Cropping processing.
* Version      : 1.00
*******************************************************************************/
#ifndef R_DRP_CROPPING_H
#define R_DRP_CROPPING_H
...
typedef struct
{
    ...
    uint16_t offset_x;      /* X coordinate to start cropping. */
    uint16_t offset_y;      /* Y coordinate to start cropping. */
