...
*******************************************************************************/
/*******************************************************************************
* File Name    : r_drp_image_rotate.h
* Description  : This source code is the header file of
*              : Rotating image processing.
* Version      : 1.00
*******************************************************************************/
#ifndef R_DRP_IMAGE_ROTATE_H
#define R_DRP_IMAGE_ROTATE_H
...
typedef struct
{
    ...
    uint16_t dst_stride;    /* The stride size of output image. */
    uint8_t mode;           /* Execution mode */
