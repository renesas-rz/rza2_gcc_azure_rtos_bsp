...
*******************************************************************************/
/*******************************************************************************
* File Name   : r_drp_simple_isp_obj_det_color.h
* Description : This source code performs SimpleISP with object detection by color(HSV).
* Version     : 1.00
******************************************************************************/
#ifndef R_DRP_SIMPLE_ISP_OBJ_DET_COLOR_H
#define R_DRP_SIMPLE_ISP_OBJ_DET_COLOR_H
...
#endif /* R_DRP_SIMPLE_ISP_OBJ_DET_COLOR_H */
