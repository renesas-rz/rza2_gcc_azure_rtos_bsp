 ...
 ***********************************************************************************************************************/
#ifndef R_USBH0_HHID_CONFIG_H
#define R_USBH0_HHID_CONFIG_H
 ...
 */
#define USBH0_CFG_HHID_INT_IN         (USBH0_PIPE6)
#define USBH0_CFG_HHID_INT_IN2        (USBH0_PIPE7)
#define USBH0_CFG_HHID_INT_IN3        (USBH0_PIPE8)
#define USBH0_CFG_HHID_INT_IN4        (USBH0_PIPE9)
#define USBH0_CFG_HHID_INT_IN5        (USBH0_PIPE10)

/** [Setting pipe to be used]
 * USB_CFG_HHID_INT_OUT     : Pipe number (USB_PIPE6 to USB_PIPE9) 1st Device HID Interrupt Out Pipe
 */
#define USBH0_CFG_HHID_INT_OUT        (USBH0_PIPE14)
