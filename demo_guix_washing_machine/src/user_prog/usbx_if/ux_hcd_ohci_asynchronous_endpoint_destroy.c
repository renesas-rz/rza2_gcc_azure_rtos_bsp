...
#if 1
            _ux_hcd_ohci_register_write(hcd_ohci, OHCI_HC_CONTROL_HEAD_ED, _ux_utility_physical_address(ed));
#else
...
#if 1
            _ux_hcd_ohci_register_write(hcd_ohci, OHCI_HC_BULK_HEAD_ED, _ux_utility_physical_address(ed));
#else
