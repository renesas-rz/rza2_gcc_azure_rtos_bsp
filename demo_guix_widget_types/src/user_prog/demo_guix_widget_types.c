...
GX_COLOR scratchpad[SCRATCHPAD_PIXELS] __attribute__ ((section("ImageWork_RAM")));
...
extern UINT gr_mango_graphics_driver_setup_24xrgb(GX_DISPLAY *display);
#elif (COLOR_FORMAT == GX_COLOR_FORMAT_32ARGB)
extern UINT gr_mango_graphics_driver_setup_32argb(GX_DISPLAY *display);
#elif (COLOR_FORMAT == GX_COLOR_FORMAT_565RGB)
extern UINT gr_mango_graphics_driver_setup_565rgb(GX_DISPLAY *display);
#endif
...
VOID start_guix(void)
{
    ...
    gx_studio_display_configure(PRIMARY,
#if (COLOR_FORMAT == GX_COLOR_FORMAT_24XRGB)
                                gr_mango_graphics_driver_setup_24xrgb,
#elif (COLOR_FORMAT == GX_COLOR_FORMAT_32ARGB)
                                gr_mango_graphics_driver_setup_32argb,
#elif (COLOR_FORMAT == GX_COLOR_FORMAT_565RGB)
                                gr_mango_graphics_driver_setup_565rgb,
#endif
