...
* Return Value : none
**********************************************************************/
void R_MIPI_Initialize(void (* const init_func)(uint32_t),  
...
* Return Value : Error code
**********************************************************************/
e_mipi_error_t R_MIPI_Close(void (* const finalize_func)(uint32_t),  
        const uint32_t user_num)
{
    e_mipi_error_t merr = MIPI_OK;
...
* Return Value : Error code
**********************************************************************/
e_mipi_error_t R_MIPI_SetBufferAdr(const uint8_t buffer_no,  
