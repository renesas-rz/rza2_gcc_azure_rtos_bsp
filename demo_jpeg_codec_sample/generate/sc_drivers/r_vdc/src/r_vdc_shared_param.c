 ...
 *********************************************************************************************************************/
/**************************************************************************//**
 * File Name :   r_vdc_shared_param.c
...
void VDC_ShrdPrmSetOutputParam (const vdc_output_t * const param) 
{
    ...
    shared_param_common->bg_color_crycb

    /* Cast to an appropriate type */
    = (uint32_t)((cr_val << VDC_SPARA_SHIFT_16) | (y_val << VDC_SPARA_SHIFT_8) | cb_val);
 ...
 *****************************************************************************/
vdc_gr_ln_off_dir_t VDC_ShrdPrmGetLineOfsAddrDir  
 ...
 *****************************************************************************/
vdc_gr_flm_sel_t VDC_ShrdPrmGetSelFbAddrSig  
                (const vdc_graphics_type_t graphics_id)
{
 ...
 *****************************************************************************/
vdc_gr_format_t VDC_ShrdPrmGetGraphicsFormat  
                (const vdc_graphics_type_t graphics_id)
{
 ...
 *****************************************************************************/
vdc_color_space_t VDC_ShrdPrmGetColorSpaceFbRd 
                (const vdc_graphics_type_t graphics_id)
{
 ...
 *****************************************************************************/
vdc_onoff_t VDC_ShrdPrmGetMeasureFolding 
            (const vdc_graphics_type_t graphics_id)
{
 ...
 *****************************************************************************/
vdc_period_rect_t * VDC_ShrdPrmGetDisplayArea 
                    (const vdc_graphics_type_t graphics_id)
{
...
void VDC_ShrdPrmSetResource  
    (const vdc_resource_type_t rsrc_type, const vdc_resource_state_t rsrc_state)
{
...
void VDC_ShrdPrmSetLayerResource 
    (const vdc_layer_id_t layer_id, const vdc_resource_state_t rsrc_state)
{
 ...
 *****************************************************************************/
vdc_resource_state_t VDC_ShrdPrmGetResource  
 ...
 *****************************************************************************/
vdc_resource_state_t VDC_ShrdPrmGetLayerResource  
 ...
 *****************************************************************************/
vdc_resource_state_t VDC_ShrdPrmGetRwProcEnabled  
                        (const vdc_layer_id_t layer_id)
{
    vdc_resource_state_t state;
