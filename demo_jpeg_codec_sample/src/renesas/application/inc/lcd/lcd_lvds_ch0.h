...
/*  LCD WVGA signal 800x480
    Pixel clock frequency: 44.0 MHz
    Refresh rate: 79.365Hz
...
#define     LCD_CH0_TCON_PIN_HSYNC  (VDC_LCD_TCON_PIN_2)       /* Select TCON of a Hsync signal (Hsync_TCON_select) */
#define     LCD_CH0_TCON_PIN_DE     (VDC_LCD_TCON_PIN_3)       /* Select TCON of a DE signal    (DE_TCON_select)    */
