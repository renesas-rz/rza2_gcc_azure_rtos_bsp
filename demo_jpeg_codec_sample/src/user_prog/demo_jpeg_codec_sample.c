/* This is a small demo that decodes JPEG compressed image and encodes to JPEG compressed image using JPEG codec unit (JCU).  */
...
void    thread_0_entry(ULONG thread_input)
{
    ...
    printf("Copyright (C) 2021 Renesas Electronics Corporation. All rights reserved.\r\n");
