...
/** Vector handlers */
    ...
    #define R_OS_ABSTRACTION_CFG_PRV_SVC_HANDLER       (svc_handler)
...
//    #define R_OS_ABSTRACTION_CFG_PRV_IRQ_HANDLER       (irq_handler)
//    #define R_OS_ABSTRACTION_CFG_PRV_FIQ_HANDLER       (fiq_handler)
    #define R_OS_ABSTRACTION_CFG_PRV_IRQ_HANDLER       (__tx_irq_handler)
    #define R_OS_ABSTRACTION_CFG_PRV_FIQ_HANDLER       (__tx_fiq_handler)
