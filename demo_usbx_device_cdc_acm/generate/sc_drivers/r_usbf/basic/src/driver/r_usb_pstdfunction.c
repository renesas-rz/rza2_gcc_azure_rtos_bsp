...
#if USB_CFG_DMA == USB_CFG_ENABLE  //20190111 ADD sawada
...
usb_dma_int_t g_usb_cstd_dma_int __attribute__ ((section ("USB_DATA_RAM")));  //20190111 COMMOUT extern sawada
#endif
