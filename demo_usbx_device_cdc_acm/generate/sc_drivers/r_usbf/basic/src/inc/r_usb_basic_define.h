...
#define USB_MAX_PIPE_NO                     (15u)       /* PIPE0 ... PIPE15 */
 ...
 *************************************************************************/
#define USB_SND_MSG(ID, MESS)           (usb_cstd_snd_msg((uint8_t)(ID), (p_os_msg_t*)(MESS)))
#define USB_ISND_MSG(ID, MESS)          (usb_cstd_isnd_msg((uint8_t)(ID), (p_os_msg_t*)(MESS)))
#define USB_WAI_MSG(ID, MESS, TM)       (usb_cstd_wai_msg((uint8_t)(ID), (p_os_msg_t*)(MESS), (usb_tm_t)(TM)))
#define USB_RCV_MSG(ID, MESS)           (usb_cstd_rec_msg((uint8_t)(ID), (p_os_msg_t**)(MESS), (usb_tm_t)(0u)))
#define USB_TRCV_MSG(ID, MESS, TM)      (usb_cstd_rec_msg((uint8_t)(ID), (p_os_msg_t**)(MESS), (usb_tm_t)(TM)))
