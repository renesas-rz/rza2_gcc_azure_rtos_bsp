 ...
 * USB_CFG_CH1          : Uses DMAC1
 */
#define     USB_CFG_USB1_DMA_TX     (USB_CFG_CH0)

/** [DMA Channel setting(USB1 module Receive transfer)]
 * USB_CFG_CH0          : Uses DMAC0
 * USB_CFG_CH1          : Uses DMAC1
 */
#define     USB_CFG_USB1_DMA_RX     (USB_CFG_CH1)
 ...
 *  15                  : highest
 */
#define USB_CFG_INTERRUPT_PRIORITY  (25) //(configMAX_API_CALL_INTERRUPT_PRIORITY)

/* 
 * Setting whether API is called form the multiple tasks or not
 *  USB_CFG_DISABLE     : Not calling API from the multiple tasks
 *  USB_CFG_ENABLE      : Calling API from the multiple tasks
 */
//#define USB_CFG_MULTIPLE_TASKS      (USB_CFG_DISABLE)
#define USB_CFG_MULTIPLE_TASKS      (USB_CFG_ENABLE)
 ...
 */
/* #define USB_CFG_USE_USBIP           (USB_CFG_IP1) */
