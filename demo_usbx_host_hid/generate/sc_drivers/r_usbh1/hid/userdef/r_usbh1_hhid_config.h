 ...
 ***********************************************************************************************************************/
#ifndef R_USBH1_HHID_CONFIG_H
#define R_USBH1_HHID_CONFIG_H
 ...
 */
#define USBH1_CFG_HHID_INT_IN         (USBH1_PIPE6)
#define USBH1_CFG_HHID_INT_IN2        (USBH1_PIPE7)
#define USBH1_CFG_HHID_INT_IN3        (USBH1_PIPE8)
#define USBH1_CFG_HHID_INT_IN4        (USBH1_PIPE9)
#define USBH1_CFG_HHID_INT_IN5        (USBH1_PIPE10)

/** [Setting pipe to be used]
 * USB_CFG_HHID_INT_OUT     : Pipe number (USB_PIPE6 to USB_PIPE9) 1st Device HID Interrupt Out Pipe
 */
#define USBH1_CFG_HHID_INT_OUT        (USBH1_PIPE14)
